                                        ...
                                        <div class="cart-list">
                                            <div class="product-widget">
                                                ...
                                                <div class="product-body">
                                                    <h3 class="product-name"><a href="#">Dre Earphone </a></h3>
                                                    <h4 class="product-price"><span class="qty">1x</span>$20.00/per day</h4>
                                                </div>
                                            ...
                                            <div class="product-widget">
                                                ...
                                                <div class="product-body">
                                                    <h3 class="product-name"><a href="#">Dre Earphone</a></h3>
                                                    <h4 class="product-price"><span class="qty">3x</span>$20.00/per day</h4>
                                                </div>
                                                <button class="delete"><i class="fa fa-close"></i></button>
                                            </div>
                                        </div>
